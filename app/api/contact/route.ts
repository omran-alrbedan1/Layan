          ...
          <tr>
            <td style="background:#1a1a1a;padding:36px 28px;text-align:center;">
              ...
              <div style="margin-bottom:16px;">
                <img src="https://layan-puce.vercel.app/assets/logo-as-CZhQ19Bt.jpg" alt="Layan Jewellery" style="width:60px;height:60px;border-radius:50%;border:2px solid #E6C687;">
              </div>
